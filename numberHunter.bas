...
Private Sub Full_Number_Hunter(rCell As Range)
  Set ws = rCell.Worksheet
    ...
    Dim d As Long, nws As Worksheet
...
For Each aSh In ActiveWorkbook.Worksheets
    If Left(aSh.Name, Len(sName)) = sName Then
        sCount = sCount + 1
    End If
Next aSh
theWS.Name = sName & Application.WorksheetFunction.Base(sCount, 10, 3)
End Sub


Private Function itell_BPC_API() As Object
